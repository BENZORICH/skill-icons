...
Change the `&theme=light` to either `dark` or `light`. The theme controls the background color, so light theme has a white icon background, and dark has a dark background.
...
Thank you for using this maintained fork. If you want to support the work around hosting and maintenance, you can sponsor me on GitHub:

<a href="https://github.com/sponsors/BENZORICH" target="_blank" rel="noopener noreferrer">
  <img src="https://img.shields.io/badge/Sponsor%20me-GitHub%20Sponsors-30363D?style=for-the-badge&logo=githubsponsors&logoColor=white" alt="Sponsor me on GitHub">
</a>

For original project credit, updates and inspiration, please also check out the upstream repository:
